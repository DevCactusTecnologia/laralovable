                    ...
                    <?php if($role == 'admin'): ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('routine.production.by.exam.index')); ?>">
                                    <i class='mdi mdi-microscope mr-2'></i>Produção por exame
                                </a>
...
<?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/layouts/hor-menu.blade.php ENDPATH**/ ?>