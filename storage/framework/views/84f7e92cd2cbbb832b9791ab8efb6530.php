<?php $__env->startSection('title'); ?> <?php echo e(__('Perfil do Recepcionista')); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('title'); ?> Perfil do Recepcionista  <?php $__env->endSlot(); ?>
        <?php $__env->slot('li_1'); ?> Dashboard <?php $__env->endSlot(); ?>
        <?php $__env->slot('li_2'); ?> <a href="<?php echo e(route('receptionists.index')); ?>">Recepcionistas</a> <?php $__env->endSlot(); ?>
        <?php $__env->slot('li_3'); ?> Perfil do Recepcionista <?php $__env->endSlot(); ?>
                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="text-primary p-3">
                                <h5 class="text-primary"><?php echo e(__('Informações do Recepcionista')); ?></h5>
                            </div>
                        </div>
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <h5 class="font-size-15"> <?php echo e($receptionist->first_name); ?></h5>
                            ...
                            <div class="pt-4">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <?php if($receptionist->last_login): ?>
                                            <p class="text-muted mb-0">
                                                <?php echo e(date('d/m/Y H:i:s', strtotime($receptionist->last_login))); ?>
                        ...
                        <table class="table mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo e($receptionist->first_name); ?></td>
                                </tr>
                                <tr>
                        ...
                        <div class="tab-pane active" id="AppointmentList" role="tabpanel">
                            ...
                            <div class="col-md-12 text-center mt-3">
                                <div class="d-flex justify-content-start">
                                    ...
                                    <?php echo e($appointments->total()); ?> entrada
                                </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/receptionists/show.blade.php ENDPATH**/ ?>