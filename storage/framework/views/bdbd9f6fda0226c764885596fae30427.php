                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                    ...
                    <div class="p-3">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="m-0"> <?php echo e(__("Notificações")); ?></h6>
                            </div>
                            <div class="col-auto">
                                <a href="<?php echo e(url('/notification-list')); ?>" class="small"> <?php echo e(__("Ver tudo")); ?></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-2 border-top">
                        <a class="btn btn-sm btn-link font-size-14 btn-block text-center" href="<?php echo e(url('/notification-list')); ?>">
                            <i class="mdi mdi-arrow-right-circle mr-1"></i> <?php echo e(__("Veja mais..")); ?>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <?php if($role == 'doctor'): ?>
                        <a class="dropdown-item" href="<?php echo e(url('profile-view')); ?>"><i
                                class="bx bx-user font-size-16 align-middle mr-1"></i> <?php echo e(__("Perfil")); ?></a>
                    ...
                    <a class="dropdown-item" href="<?php echo e(url('profile-edit')); ?>"><i
                        class="bx bx-user font-size-16 align-middle mr-1"></i> <?php echo e(__("Alterar perfil")); ?></a>
                    <?php endif; ?>
                    <a class="dropdown-item d-block" href="<?php echo e(url('change-password')); ?>"><i
                            class="bx bx-wrench font-size-16 align-middle mr-1"></i> <?php echo e(__("Alterar senha")); ?></a>
...
<?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/layouts/top-hor.blade.php ENDPATH**/ ?>