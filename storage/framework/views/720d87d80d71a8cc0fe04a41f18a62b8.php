<?php $__env->startSection('title'); ?> Atualizar paciente <?php $__env->stopSection(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('mother_name', $patient_info->mother_name)); ?>"
                            >
                            <?php $__errorArgs = ['cpf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>" name="gender" required>
                                ...
                                <option value="Male" <?php if(old('gender', $patient_info->gender) == 'Male'): echo 'selected'; endif; ?>>Masculino</option>
                                <option value="Female" <?php if(old('gender', $patient_info->gender) == 'Female'): echo 'selected'; endif; ?>>Feminino</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" placeholder="Digite o E-mail"
...
unset($__errorArgs, $__bag); ?>" placeholder="Digite o nº de Contato" 
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/patients/edit.blade.php ENDPATH**/ ?>