...
<body style="background-color: #F2F2F2; font-family: Arial, Helvetica, sans-serif; padding: 20px;">
   <div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
        ...
        <div>
            <img src="<?php echo e(asset('assets/images/error-img.png')); ?>" style="width: 100%;" alt="Não encontrado">
        </div>
    </div>
</body>

</html>
<?php /**PATH /home3/sislac63/saobento.sislac.com.br/resources/views/web/patients/not-found.blade.php ENDPATH**/ ?>