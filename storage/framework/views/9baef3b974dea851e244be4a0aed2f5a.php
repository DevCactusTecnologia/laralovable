<table style="width: 100%; font-size: 11px; border-collapse: collapse; border: 1px solid #000; margin-bottom: 10px; background-color: #e7e6e6;">
    <tr>
        <td colspan="14" style="border: 1px solid #000; height: 15px; padding-left: 5px; font-weight: 600;">HEMOGRAMA COMPLETO</td>
    </tr>
    <tr style="background-color: #F2F2F2; text-align: center; font-weight: 600; padding: 0px">
        <td style="width: 6%; padding: 0px; border: 1px solid #000;">HEMACI</td>
    ...
    <tr style="background-color: #FFF;">
        <td colspan="14" style="border: 1px solid #000; height: 15px; padding-left: 5px;">Observações:</td>
    </tr>
</table>
<?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/routine/map/patient/inc/hemogram.blade.php ENDPATH**/ ?>