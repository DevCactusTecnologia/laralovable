<?php $__env->startSection('title'); ?><?php echo e(__('Atualizar admin')); ?><?php $__env->stopSection(); ?>
            ...
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">
                        <?php echo e(__('Atualizar detalhes do admin')); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Primeiro nome ')); ?><span
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                placeholder="<?php echo e(__('Digite o primeiro nome')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Sobrenome ')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                placeholder="<?php echo e(__('Digite o sobrenome')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Nº de Contato ')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php else: ?> <?php echo e(URL::asset('assets/images/users/noImage.png')); ?> <?php endif; ?>"
                                            ...
                                            title="Clique para fazer upload da foto do perfil" />
                                            <input type="file"
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/admin/admin-edit.blade.php ENDPATH**/ ?>