...
<body>
        ...
        <div style="font-family: Arial, Helvetica, sans-serif">
            ...
            <div style="font-size: 4mm; margin-top: 10px; text-align: center;">
                Previsão de entrega: <span style="font-family: cursive;"><?php echo e(date('d/m/Y', strtotime($appointment->delivery_date))); ?></span>
            </div>
        </div> 
...
<?php /**PATH /home/hsdrjarques/public_html/resources/views/appointments/print.blade.php ENDPATH**/ ?>