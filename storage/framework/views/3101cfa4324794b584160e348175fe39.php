<?php $__env->startSection('title'); ?><?php echo e(__('Adicionar novo recepcionista')); ?><?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('title'); ?> Adicionar novo recepcionista <?php $__env->endSlot(); ?>
        ...
        <?php $__env->slot('li_3'); ?> Adicionar novo recepcionista <?php $__env->endSlot(); ?>
    <?php echo $__env->renderComponent(); ?>

    <div class="row">
        <div class="col-12">
            <a href="<?php echo e(route('receptionists.index')); ?>" class="btn btn-primary waves-effect mb-3">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="<?php echo e(route('receptionists.store')); ?>" method="POST" 
...
unset($__errorArgs, $__bag); ?>" 
                                name="cpf" id="cpf" value="<?php echo e(old('cpf')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-0"></div>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                id="profile_display" onclick="triggerClick()" data-toggle="tooltip" data-placement="top" 
...
unset($__errorArgs, $__bag); ?>" 
                                name="new_profile_photo" id="new_profile_photo" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3 form-group mb-0"></div>
                    </div>
                        
                    <div class="row">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary">
                                <?php echo e(__('Adicionar novo recepcionista')); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/receptionists/create.blade.php ENDPATH**/ ?>