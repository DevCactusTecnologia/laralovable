<table style="width: 100%; font-size: 11px; border-collapse: collapse; border: 1px solid #000; margin-bottom: 10px;">
    <tr>
        <td colspan="4" style="height: 8px; padding-left: 5px; background-color: #e7e6e6; font-weight: 600;">URINA DE JATO MÉDIO</td>
    </tr>
    <tr style="background-color: #F2F2F2; font-weight: 600; border-top: 1px solid #000;">
        ...
        <td style="width: 32%; padding: 0px; border: 1px solid #000; padding-left: 5px;">MICROSCOPIA DO SEDIMENTO (400x)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid #000; padding-left: 5px;">Leucócitos</td>
    </tr>
    <tr>
        ...
        <td style="border: 1px solid #000; padding-left: 5px;">Piocitos:</td>
    </tr>
    <tr>
        <td style="border: 1px solid #000; padding-left: 5px;">Depósitos:</td>
        <td style="border: 1px solid #000; padding-left: 5px;">Glicose Sais Biliares:</td>
        <td style="border: 1px solid #000;"></td>
        <td style="border: 1px solid #000; padding-left: 5px;">Hemácias:</td>
    </tr>
    <tr>
        ...
        <td style="border: 1px solid #000;"></td>
        <td style="border: 1px solid #000; padding-left: 5px;">Cilindro:</td>
    </tr>
    <tr style="margin-bottom: 10px;">
        ...
        <td style="border: 1px solid #000;"></td>
        <td style="border: 1px solid #000; padding-left: 5px;">Cristais:</td>
    </tr>
    <tr style="margin-bottom: 10px;">
        <td colspan="3" style="border: 1px solid #000; padding-left: 5px;">Observações:</td>
        <td style="border: 1px solid #000; padding-left: 5px;">Muco:</td>
    </tr>
</table>
<?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/routine/map/patient/inc/urina.blade.php ENDPATH**/ ?>