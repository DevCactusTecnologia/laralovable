                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="<?php if($biomedical->profile_photo != ''): ?><?php echo e(asset('storage/images/users/' . $biomedical->profile_photo)); ?><?php else: ?><?php echo e(URL::asset('assets/images/users/noImage.png')); ?><?php endif; ?>" alt="<?php echo e($biomedical->fisrt_name); ?>"
                    ...
                    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#AppointmentList" role="tab">
                                ...
                                <span class="d-none d-sm-block">Lista de atendimentos</span>
                            </a>
                        </li>
                        <li class="nav-item">
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/biomedicals/show.blade.php ENDPATH**/ ?>