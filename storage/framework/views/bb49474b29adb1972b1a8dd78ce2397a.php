<?php $__env->startSection('title'); ?> Inserir resultado <?php $__env->stopSection(); ?>
                            ...
                            <div class="col-8">
                                <div class="d-flex flex-column">
                                    <div>
                                        ...
                                        <?php if($appointment->patient->patient->patient_social_name): ?> (<?php echo e($appointment->patient->patient->patient_social_name); ?>) <?php endif; ?>
                                    </div>
                                    <div>
                                        Idade &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;
                        ...
                        <div class="list-group" id="list-tab" role="tablist">
                            <?php $__currentLoopData = $appointment->exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                >
                                    ...
                                    <?php elseif($exam->pivot->status == '2' && $exam->pivot->re_test == '1'): ?>
                                                ...
                                                <select class="form-control" name="biomedical_id" required>
                                                    ...
                                                    <?php $__currentLoopData = $biomedicals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biomedical): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($biomedical->id); ?>" 
                                                            <?php if($exam->pivot->biomedical_id == $biomedical->id): echo 'selected'; endif; ?>
                                                        >
                                        ...
                                        <form action="<?php echo e(route('appointments.result.save')); ?>" method="POST">
                                            ...
                                            <div class="form-group mt-3">
                                                ...
                                                <select class="form-control" name="biomedical_id" required>
                                                    ...
                                                    <?php $__currentLoopData = $biomedicals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biomedical): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($biomedical->id); ?>"
                                                            <?php if($biomedical->id == $exam->pivot->biomedical_id): echo 'selected'; endif; ?>
                                                        >
                                                            <?php echo e($biomedical->first_name); ?>
...
EOL;
                                    ...
                                    <?php echo $__env->make('appointments.result.modal-cancel-retest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/appointments/result/create.blade.php ENDPATH**/ ?>