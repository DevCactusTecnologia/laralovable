...
unset($__errorArgs, $__bag); ?>" 
                                value="<?php echo e(old('first_name')); ?>" maxlength="28" required
                            >
...
unset($__errorArgs, $__bag); ?>"
                                name="cpf" id="cpf" value="<?php echo e(old('cpf')); ?>" placeholder="Digite o nº do CPF"
                            >
                            <?php $__errorArgs = ['cpf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>"
                                name="cns" id="cns" value="<?php echo e(old('cns')); ?>" placeholder="Digite o nº do cartão SUS"
                            >
                            <?php $__errorArgs = ['cns'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>"
                                name="password" id="password" value="<?php echo e(old('password')); ?>" placeholder="Digite a senha"
                            >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3 form-group">
                            <label class="control-label">Nº de Contato<span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                placeholder="DIgite o nº do contato" required
                            >
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/pages/biomedicals/script.js')); ?>?version=3"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/biomedicals/create.blade.php ENDPATH**/ ?>