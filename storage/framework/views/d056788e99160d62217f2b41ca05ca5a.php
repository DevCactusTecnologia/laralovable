<?php $__env->startSection('title'); ?> Lista de Atendimentos <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
                            ...
                            <table class="table table-sm table-centered table-bordered table-hover dt-responsive nowrap">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th style="width: 9%;" class="text-center">Protocolo</th>
                                ...
                                <tbody id="contentAppointment">
                                    ...
                                    <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-uppercase"><?php echo e($appointment->doctor_name); ?></td>
                                            <td>
                                                <?php if($appointment->patient_name_social): ?> <div class="font-weight-bold"><?php echo e($appointment->patient_name_social); ?></div> <?php endif; ?>
                                                <div><?php echo e($appointment->patient_name); ?><div>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group dropleft">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <button type="button" class="dropdown-item pl-4" data-toggle="modal" data-target="#cancel"
                                                                data-protocol="<?php echo e($appointment->protocol); ?>" onclick="cancel(this)"
                                                                data-url="<?php echo e(route('appointments.cancel', $appointment->protocol)); ?>"
                                                                style="outline: none !important; background-color: transparent; border: none;"
                                                            >
                                                        ...
                                                        <li>
                                                            <a href="<?php echo e(route('routine.tag.print', $appointment->protocol)); ?>"
                                                                class="dropdown-item" target="_blank"
                                                            >
                                                                <svg xmlns="http://www.w3.org/2000/svg" height="15" width="15" viewBox="0 0 48 48">
                                                                    <path d="M35.9 14.1H12.1V6h23.8Zm1.05 9.25q.6 0 1.05-.45.45-.45.45-1.05 0-.6-.45-1.05-.45-.45-1.05-.45-.6 0-1.05.45-.45.45-.45 1.05 0 .6.45 1.05.45.45 1.05.45ZM32.9 39v-9.6H15.1V39Zm3 3H12.1v-8.8H4V20.9q0-2.25 1.525-3.775T9.3 15.6h29.4q2.25 0 3.775 1.525T44 20.9v12.3h-8.1Z"/>
                                                                </svg>
                                                                <span class="ml-2">Imprimir etiqueta</span>
                                                            </a>
                                                        </li>
                                                    </div>
                                                </div>
        ...
        <?php echo $__env->make('appointments.modal.cancel.view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u444904474/domains/sislac.com.br/public_html/coremas.sislac.com.br/resources/views/appointments/index.blade.php ENDPATH**/ ?>