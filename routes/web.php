...
use App\Http\Controllers\Routine\ProductionExamController;
...
Route::middleware('sentinel.auth')->group(function () {
    ...
    Route::prefix('routine')->name('routine.')->group(function () {
        ...
        Route::name('production.by.exam.')
            ->controller(ProductionExamController::class)
            ->group(function () {
                Route::get('production-by-exam', 'index')->name('index');
                Route::post('production-by-exam-search', 'searchAll')->name('search.all');
                Route::get('production-by-exam/between/{dateStart}/{dateEnd}/print', 'print')->name('print');
            });
