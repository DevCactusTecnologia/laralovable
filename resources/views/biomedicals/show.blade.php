                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="@if ($biomedical->profile_photo != ''){{ asset('storage/images/users/' . $biomedical->profile_photo) }}@else{{ URL::asset('assets/images/users/noImage.png') }}@endif" alt="{{ $biomedical->fisrt_name }}"
