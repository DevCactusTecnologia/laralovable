                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control @error('cpf') is-invalid @enderror"
                                name="cpf" id="cpf" value="{{ old('cpf', $biomedical_info->cpf) }}" placeholder="Digite o nº do CPF"
                            >
                            @error('cpf')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group mb-0">
                            ...
                            <img class="@error('profile_photo') is-invalid @enderror"
                                src="@if ($biomedical && $biomedical->profile_photo != null){{ asset('storage/images/users/' . $biomedical->profile_photo) }}@else{{ URL::asset('assets/images/users/noImage.png') }}@endif" 
                        ...
                        <div class="col-md-3 form-group mb-0">
                            ...
                            <img class="@error('signature') is-invalid @enderror" 
                                src="@if ($biomedical && $biomedical_info->signature){{ asset('storage/images/users/signature/' . $biomedical_info->signature) }}@else{{ URL::asset('assets/images/users/noImage.png') }}@endif" 
