                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="first_name" placeholder="Digite o nome sem abreviações"
                                ...
                                value="{{ old('first_name') }}" maxlength="28" required
                            >
                            @error('first_name')
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control @error('cpf') is-invalid @enderror"
                                name="cpf" id="cpf" value="{{ old('cpf') }}" placeholder="Digite o nº do CPF"
                            >
                            @error('cpf')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control @error('cns') is-invalid @enderror"
                                name="cns" id="cns" value="{{ old('cns') }}" placeholder="Digite o nº do cartão SUS"
                            >
                            @error('cns')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" class="form-control @error('password') is-invalid @enderror"
                                name="password" id="password" value="{{ old('password') }}" placeholder="Digite a senha"
                            >
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
...
@section('script')
    ...
    <script src="{{ asset('assets/js/pages/biomedicals/script.js') }}?version=3"></script>
@endsection
