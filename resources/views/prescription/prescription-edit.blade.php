                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('prescription') }}">{{ __('Prescrição') }}</a>
                            </li>
                                                ...
                                                <div data-repeater-item class="mb-3 row">
                                                    ...
                                                    <div class="col-md-5 col-6">
                                                        <textarea type="text" name="notes" class="form-control"
                                                            placeholder="{{ __('Observações...') }}">{{ $item->notes }}</textarea>
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class='repeater mb-4'>
                                            <div data-repeater-list="test_reports" class="form-group">
                                                <label>{{ __('Solicitar Exames ') }}<span
                                                        class="text-danger">*</span></label>
                                                <div data-repeater-item class="mb-3 row">
                                                    <div class="col-md-5 col-6">
