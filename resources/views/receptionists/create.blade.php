...
@section('title'){{ __('Adicionar novo recepcionista') }}@endsection
...
<div class="s-page">
    @component('components.breadcrumb')
        @slot('title') Adicionar novo recepcionista @endslot
        @slot('li_1') <a href="{{ url('/') }}">{{ __('Dashboard') }}</a> @endslot
        @slot('li_2') <a href="{{ route('receptionists.index') }}">{{ __('Recepcionistas') }}</a> @endslot
        @slot('li_3') Adicionar novo recepcionista @endslot
    @endcomponent

    <div class="row">
        <div class="col-12">
            <a href="{{ route('receptionists.index') }}" class="btn btn-primary waves-effect mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary">
                                {{ __('Adicionar novo recepcionista') }}
                            </button>
                        </div>
                    </div>
                </form>
