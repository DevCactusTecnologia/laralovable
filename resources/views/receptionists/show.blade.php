...
@section('title') {{ __('Perfil do Recepcionista') }} @endsection
...
<div class="s-page">
    @component('components.breadcrumb')
        @slot('title') Perfil do Recepcionista  @endslot
        @slot('li_1') Dashboard @endslot
        @slot('li_2') <a href="{{ route('receptionists.index') }}">Recepcionistas</a> @endslot
        @slot('li_3') Perfil do Recepcionista @endslot
    @endcomponent
                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="text-primary p-3">
                                <h5 class="text-primary">{{ __('Informações do Recepcionista') }}</h5>
                            </div>
                        </div>
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <h5 class="font-size-15"> {{ $receptionist->first_name }}</h5>
                            ...
                            <div class="pt-4">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        @if ($receptionist->last_login)
                                            <p class="text-muted mb-0">
                                                {{ date('d/m/Y H:i:s', strtotime($receptionist->last_login)) }}
                                            </p>
                                        @else
