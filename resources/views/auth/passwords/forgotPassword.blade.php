                            ...
                            <div class="p-2">
                                <form class="form-horizontal" method="POST" action="{{ url('forgot-password') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" @if (old('email')) value="{{ old('email') }}" @endif id="username" placeholder="{{ __("Digite o e-mail") }}" autocomplete="email" autofocus>
                                        @error('email')
