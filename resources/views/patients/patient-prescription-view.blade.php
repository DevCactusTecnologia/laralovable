...
<div class="s-page">
        ...
        @component('components.breadcrumb')
            ...
            @slot('li_2') Lista de prescrição @endslot
            ...
            <div class="col-12">
                <a href="{{ url('prescription-list') }}">
                    <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                        <i
                            class="bx bx-arrow-back font-size-16 align-middle mr-2"></i>{{ __('Voltar para lista de prescrição') }}
                    </button>
                </a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <address>
                                    <strong>{{ __('Data da prescrição: ') }}</strong>{{ $user_details->created_at }}<br>
                                    <strong>{{ __('Data do encontro: ') }}</strong>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="py-2 mt-3">
                                    <h3 class="font-size-15 font-weight-bold">{{ __('Solicitar Exames') }}</h3>
                                </div>
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
