                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="@if ($doctor->profile_photo != ''){{ URL::asset('storage/images/users/' . $doctor->profile_photo) }}@else{{ URL::asset('assets/images/users/noImage.png') }}@endif" alt="{{ $doctor->first_name }}" class="img-thumbnail rounded-circle">
                            </div>
                            <h5 class="font-size-15"> {{ @$doctor->first_name }}
                                {{ @$doctor->last_name }} </h5>
                        ...
                        <div class="col-sm-7">
                            <div class="pt-4">
                                ...
                                <div class="mt-4">
                                    <a href="{{ url('profile-edit') }}" class="btn btn-primary waves-effect waves-light btn-sm">{{ __('Editar Perfil') }}
