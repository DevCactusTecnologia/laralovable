                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                    ...
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="{{ url('/notification-list') }}" class="small"> {{ __("Ver tudo") }}</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    @if ($role == 'doctor')
                        <a class="dropdown-item" href="{{ url('profile-view') }}"><i
                                class="bx bx-user font-size-16 align-middle mr-1"></i> {{ __("Perfil") }}</a>
                    @elseif($role == 'patient')
                        <a class="dropdown-item" href="{{ url('profile-view') }}"><i
                                class="bx bx-user font-size-16 align-middle mr-1"></i> {{ __("Perfil") }}</a>
                    ...
                    <a class="dropdown-item" href="{{ url('profile-edit') }}"><i
                        class="bx bx-user font-size-16 align-middle mr-1"></i> {{ __("Alterar perfil") }}</a>
                    @endif
                    <a class="dropdown-item d-block" href="{{ url('change-password') }}"><i
                            class="bx bx-wrench font-size-16 align-middle mr-1"></i> {{ __("Alterar senha") }}</a>
