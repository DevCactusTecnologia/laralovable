                    ...
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-0 font-weight-medium">
                                        <div>Pendentes: {{ $occurrences->pending }}</div>
                                        <div>Resolvidas: {{ $occurrences->resolved }}</div>
                                    </div>
                                    <div class="mini-stat-icon avatar-sm rounded-lg bg-primary align-self-center">
                                        <span class="avatar-title">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-md-flex justify-content-md-between align-items-center mb-3">
                    ...
                    <a href="{{ route('appointments.index') }}" class="btn btn-primary waves-effect font-weight-medium px-4">
                            ...
                            @foreach ($appointments as $appointment)
                                <tr>
                                    ...
                                    <td class="font-weight-medium">
                                        @if($appointment->patient_name_social) <div class="text-dark">Nome Social: {{ $appointment->patient_name_social }}</div> @endif
                                        <div class="text-secondary">{{ $appointment->patient_name }}</div>
                                    </td>
