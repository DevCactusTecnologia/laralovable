        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <!-- Settings -->
                <hr class="mt-0" />
                <h6 class="text-center">{{ __("Escolher layouts") }}</h6>
                <div class="p-4">
                    <div class="mb-2">
                    ...
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input theme-choice" id="light-mode-switch"
                            checked />
                        <label class="custom-control-label" for="light-mode-switch">{{ __("Modo de luz") }}</label>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="custom-control custom-switch mb-3">
                        ...
                        <label class="custom-control-label" for="dark-mode-switch">{{ __("Modo Escuro") }}</label>
                    </div>
                    <div class="mb-2">
