                ...
                <div style="font-family: Arial, Helvetica, sans-serif;">
                    <div data-js="header" style="display: flex; margin-bottom: 5px; align-items: center;">
                        ...
                        <div style="display: flex; flex-direction: column; justify-content: center; align-items: flex-start;">
                            <h5 style="font-weight: 700; margin: 1px 0px;">PREFEITURA DE COREMAS</h5>
                            <h5 style="font-weight: 700; margin: 1px 0px;">SECRETARIA MUNICIPAL DE SAÚDE</h5>
                            <h5 style="font-weight: 700; margin: 1px 0px;">LABORATORIO DE ANALISES CLINICAS DE COREMAS</h5>
                        </div>
                    </div>
                    <hr>
