...
@section('title') Lista de Atendimentos @endsection
...
<div class="s-page">
    ...
    <div class="row">
                            ...
                            <table class="table table-sm table-centered table-bordered table-hover dt-responsive nowrap">
                                ...
                                <tbody id="contentAppointment">
                                    ...
                                    @foreach ($appointments as $appointment)
                                        ...
                                        <tr>
                                            <td>{{ $loop->iteration + 0 + $per_page * ($currentpage - 1) }}</td>
                                            <td class="text-uppercase">{{ $appointment->doctor_name }}</td>
                                            <td>
                                                @if($appointment->patient_name_social) <div class="font-weight-bold">{{ $appointment->patient_name_social }}</div> @endif
                                            ...
                                            <td>
                                                @if ($role == 'admin' || $role == 'receptionist' || $role == 'biomedical')
                                                    ...
                                                    <a href="{{ route('appointments.result.create', $appointment->protocol) }}" 
                                                ...
                                                <div class="btn-group dropleft">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <li>
                                                            <a href="{{ route('appointments.print', $appointment->protocol) }}"
                                                        ...
                                                        <li>
                                                            <a type="button" class="dropdown-item" 
                                                                href="{{ route('appointments.edit', $appointment->protocol) }}"
                                                            >
                                                                <svg xmlns="http://www.w3.org/2000/svg" height="15" width="15" viewBox="0 0 48 48">
                                                        ...
                                                        <li>
                                                            <button type="button" class="dropdown-item pl-4" data-toggle="modal" data-target="#cancel"
                                                                data-protocol="{{ $appointment->protocol }}" onclick="cancel(this)"
                                                                data-url="{{ route('appointments.cancel', $appointment->protocol) }}"
                                                        ...
                                                        <li>
                                                            <a href="{{ route('routine.tag.print', $appointment->protocol) }}"
                                                                class="dropdown-item" target="_blank"
                                                            >
                                                                <svg xmlns="http://www.w3.org/2000/svg" height="15" width="15" viewBox="0 0 48 48">
                                                                    <path d="M35.9 14.1H12.1V6h23.8Zm1.05 9.25q.6 0 1.05-.45.45-.45.45-1.05 0-.6-.45-1.05-.45-.45-1.05-.45-.6 0-1.05.45-.45.45-.45 1.05 0 .6.45 1.05.45.45 1.05.45ZM32.9 39v-9.6H15.1V39Zm3 3H12.1v-8.8H4V20.9q0-2.25 1.525-3.775T9.3 15.6h29.4q2.25 0 3.775 1.525T44 20.9v12.3h-8.1Z"/>
        ...
        @include('appointments.modal.pending.view')
        @include('appointments.modal.cancel.view')
    </div>
</div>
@endsection
...
@section('script')
    ...
    <script src="{{ asset('assets/js/pages/appointments/script.js') }}"></script>
@endsection
