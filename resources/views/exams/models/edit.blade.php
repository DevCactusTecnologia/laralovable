...
@section('title') Editar dados do modelo de laudo @endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div>
                        <form action="{{ route('exams.models.update', [$exam->id, $model->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="d-md-flex">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="observation"
                                        value="{{ old('observation', $model->observation) }}" 
                                    />
                                </div>
                            </div>
                            ...
                            <div class="d-md-flex mb-3">
                                <div class="col-md-12">
                                    ...
                                    <textarea id="summery-ckeditor" class="form-control" 
                                        name="exam_editor" required>{{ old('exam_editor', $model->exam_editor) }}</textarea>
                                </div>
                            </div>
