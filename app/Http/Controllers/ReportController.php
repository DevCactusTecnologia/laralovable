...
class ReportController extends Controller
{
    public function getMonthlyUsersRevenue()
    {
        ...
        $exams = DB::select(
            ...
            WHERE appointment_exams.appointment_id = appointments.id AND 
            YEAR(appointment_exams.collected_at) = YEAR(CURDATE()) AND
            (appointment_exams.status = 1 OR appointment_exams.status = 0)
